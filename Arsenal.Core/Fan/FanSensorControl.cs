...
namespace Arsenal.Fan
{
    public class FanSensorControl
    {
        ...
        public static event Action<string>? OnCalibrationStatus;
        ...
        public void StartCalibration()
        {
            ...
            for (int i = 0; i < FAN_COUNT; i++)
                Program.acpi.SetFanCurve((AsusFan)i, [20, 30, 40, 50, 60, 70, 80, 90, 100, 100, 100, 100, 100, 100, 100, 100]);
        }
        ...
        private void Timer_Elapsed(object? sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            OnCalibrationStatus?.Invoke(label);
            Program.Bridge?.LabelFansResult(label);
