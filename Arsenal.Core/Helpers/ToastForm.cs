...
namespace Arsenal.Helpers
{
    ...
    public class ToastForm : OSDNativeForm
    {
        ...
        protected string toastText = "Balanced";
        protected ToastIcon? toastIcon;
        ...
        public void RunToast(string text, ToastIcon? icon = null, string? detail = null)
        {
            if (AppConfig.Is("disable_osd")) return;

            if (Program.Bridge is not null)
            {
                Program.Bridge.ShowToast(text, icon ?? ToastIcon.Charger, detail);
                return;
            }
            ...
            try
            {
                ...
                Screen screen1 = Screen.PrimaryScreen ?? Screen.AllScreens[0];
            ...
            {
                Logger.WriteLine("Toast error: " + ex.Message);
            }
        }
