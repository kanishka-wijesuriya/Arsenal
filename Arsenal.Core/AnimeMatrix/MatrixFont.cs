...
namespace Arsenal.AnimeMatrix
{
    public static class MatrixFont
    {
        ...
        static readonly string fontFile = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Arsenal", "matrix.otf");
        ...
        public static async Task<bool> Download()
        {
            ...
            string temp = Path.Combine(Path.GetTempPath(), "ArsenalFont");
