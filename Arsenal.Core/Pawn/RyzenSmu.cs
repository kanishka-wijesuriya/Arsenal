    ...
    public sealed class RyzenSmuService : IDisposable
    {
        ...
        public bool Initialize(Assembly assembly)
        {
            ...
            using var stream = assembly.GetManifestResourceStream(name)
                ?? assembly.GetManifestResourceStream("Arsenal.Core.RyzenSMU.bin")
                ?? assembly.GetManifestResourceStream("Arsenal.RyzenSMU.bin")
                ?? (Array.Find(assembly.GetManifestResourceNames(), n => n.EndsWith("RyzenSMU.bin", StringComparison.OrdinalIgnoreCase)) is string foundName
                    ? assembly.GetManifestResourceStream(foundName)
                    : null)
