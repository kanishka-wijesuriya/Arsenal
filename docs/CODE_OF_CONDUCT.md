...
the maintainer at **legal@get-arsenal.com**. All complaints will be reviewed and
...
inappropriate, threatening, offensive or harmful. They have the right and responsibility
to remove, edit or reject comments, commits, code, issues and other contributions that
are not aligned with this Code of Conduct, and will communicate the reasons when doing
so.

Consequences escalate with severity and repetition: a private correction, a warning, a
temporary ban from interaction with the project, or a permanent ban.

## Scope

This Code of Conduct applies in all project spaces, and also when an individual is
